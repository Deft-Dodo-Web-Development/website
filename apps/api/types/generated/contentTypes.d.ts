...
export interface ApiFooterFooter extends Schema.SingleType {
  ...
  attributes: {
    ...
    copyright: Attribute.Component<'footer.copyright'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    Banner: Attribute.Component<'footer.elevate-section'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiHeaderHeader extends Schema.SingleType {
  ...
  attributes: {
    content: Attribute.Component<'shared.header'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiTeamMemberTeamMember extends Schema.CollectionType {
  ...
  attributes: {
    ...
    social: Attribute.Component<'common.social', true>;
    blogs: Attribute.Relation<
      'api::team-member.team-member',
      'oneToMany',
      'api::blog.blog'
...
export interface ApiTestimonialTestimonial extends Schema.CollectionType {
  ...
  attributes: {
    ...
    identity: Attribute.Component<'common.testimonial-identity'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
